...
class IntervencionSeeder extends Seeder
{
    ...
    {
        $fichaEconomica = TipoFicha::create([
        ...
        $fichaRedApoyo = TipoFicha::create([
        ...
        $fichaVivienda = TipoFicha::create([
        ...
        TipoValoracionFicha::create([
            ...
            'tipo_ficha_id'      => $fichaEconomica->id,
            'orden'              => 0,
            'obligatoria'        => true,
        ]);
        ...
        TipoValoracionFicha::create([
            'tipo_valoracion_id' => $tipoValoracion->id,
            'tipo_ficha_id'      => $fichaRedApoyo->id,
            'orden'              => 1,
            'obligatoria'        => false,
        ]);
        ...
        TipoValoracionFicha::create([
            'tipo_valoracion_id' => $tipoValoracion->id,
            'tipo_ficha_id'      => $fichaVivienda->id,
            'orden'              => 2,
            'obligatoria'        => false,
        ]);
    }
