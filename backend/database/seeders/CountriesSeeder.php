...
use App\Models\Country; // Asume modelo Eloquent para countries
...
class CountriesSeeder extends Seeder
{
    public function run(): void
    {
        $countries = [
            ...
            ['name' => 'Bolivia (Plurinational State of)', 'iso_code' => 'BO'],
            ['name' => 'Bonaire, Sint Eustatius and Saba', 'iso_code' => 'BQ'],
            ['name' => 'Bosnia and Herzegovina', 'iso_code' => 'BA'],
            ['name' => 'Botswana', 'iso_code' => 'BW'],
            ['name' => 'Bouvet Island', 'iso_code' => 'BV'],
            ['name' => 'Brazil', 'iso_code' => 'BR'],
            ['name' => 'British Indian Ocean Territory (the)', 'iso_code' => 'IO'],
            ...
            ['name' => 'Cayman Islands (the)', 'iso_code' => 'KY'],
            ['name' => 'Central African Republic (the)', 'iso_code' => 'CF'],
            ['name' => 'Chad', 'iso_code' => 'TD'],
            ['name' => 'Chile', 'iso_code' => 'CL'],
            ['name' => 'China', 'iso_code' => 'CN'],
            ['name' => 'Christmas Island', 'iso_code' => 'CX'],
            ['name' => 'Cocos (Keeling) Islands (the)', 'iso_code' => 'CC'],
            ['name' => 'Colombia', 'iso_code' => 'CO'],
            ['name' => 'Comoros (the)', 'iso_code' => 'KM'],
            ['name' => 'Congo (the Democratic Republic of the)', 'iso_code' => 'CD'],
            ['name' => 'Congo (the)', 'iso_code' => 'CG'],
            ['name' => 'Cook Islands (the)', 'iso_code' => 'CK'],
            ...
            ['name' => 'Dominican Republic (the)', 'iso_code' => 'DO'],
            ...
            ['name' => 'Falkland Islands (the) [Malvinas]', 'iso_code' => 'FK'],
            ['name' => 'Faroe Islands (the)', 'iso_code' => 'FO'],
            ...
            ['name' => 'French Southern Territories (the)', 'iso_code' => 'TF'],
            ['name' => 'Gabon', 'iso_code' => 'GA'],
            ['name' => 'Gambia (the)', 'iso_code' => 'GM'],
            ...
            ['name' => "Korea (the Democratic People's Republic of)", 'iso_code' => 'KP'],
            ['name' => 'Korea, Republic of', 'iso_code' => 'KR'],
            ['name' => 'Kuwait', 'iso_code' => 'KW'],
            ['name' => 'Kyrgyzstan', 'iso_code' => 'KG'],
            ['name' => "Lao People's Democratic Republic (the)", 'iso_code' => 'LA'],
            ...
            ['name' => 'Marshall Islands (the)', 'iso_code' => 'MH'],
            ...
            ['name' => 'Moldova (the Republic of)', 'iso_code' => 'MD'],
            ...
            ['name' => 'Philippines (the)', 'iso_code' => 'PH'],
            ...
            ['name' => 'Russian Federation (the)', 'iso_code' => 'RU'],
            ...
            ['name' => 'Saint Martin (French part)', 'iso_code' => 'MF'],
            ...
            ['name' => 'Sint Maarten (Dutch part)', 'iso_code' => 'SX'],
            ...
            ['name' => 'Turks and Caicos Islands (the)', 'iso_code' => 'TC'],
            ['name' => 'Tuvalu', 'iso_code' => 'TV'],
            ['name' => 'Uganda', 'iso_code' => 'UG'],
            ['name' => 'Ukraine', 'iso_code' => 'UA'],
            ['name' => 'United Arab Emirates (the)', 'iso_code' => 'AE'],
            ['name' => 'United Kingdom of Great Britain and Northern Ireland (the)', 'iso_code' => 'GB'],
            ['name' => 'United States Minor Outlying Islands (the)', 'iso_code' => 'UM'],
            ['name' => 'United States of America (the)', 'iso_code' => 'US'],
