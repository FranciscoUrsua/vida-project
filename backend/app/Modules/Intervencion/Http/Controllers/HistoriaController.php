...
use App\Modules\Intervencion\Http\Requests\CreateHistoriaRequest;
use App\Modules\Intervencion\Http\Requests\UpdateHistoriaRequest; // Similar a Create, crea si needed
